import { ArrowLeft, BadgeCheck, CalendarCheck, ChevronLeft, Clock, MapPin, Phone, Sparkles } from "lucide-react";
...
import { beforeAfterCases, devices, gallery, heroStats, siteConfig, testimonials, trustItems } from "@/lib/data";
        ...
        <main className="min-h-screen overflow-x-hidden bg-hero-glow text-foreground">
          ...
          <section id="services" className="relative z-10 section-padding">
            <div className="container">
              <SectionHeading
                ...
                title="كل خدمات العيادة في أقسام واضحة ومريحة"
                centered
              />
              <ServiceExplorer />
            </div>
          ...
          <section id="devices" className="relative z-10 section-padding">
            <div className="container">
              <SectionHeading
                badge="أجهزة الليزر"
                title="أجهزة متعددة لاختيار البروتوكول المناسب"
                centered
              />
            ...
            <div className="container">
              <div className="relative overflow-hidden rounded-[2.5rem] wine-gradient p-8 text-white shadow-soft md:p-12">
                ...
                <div className="relative grid items-center gap-8 md:grid-cols-[1fr_auto]">
                  <h2 className="text-3xl font-black leading-tight md:text-5xl text-center md:text-right">جاهزة لاستقبال Leads من أول يوم</h2>
          ...
          <section className="relative z-10 section-padding bg-white/55">
            <div className="container">
              <SectionHeading
                badge="آراء العملاء"
                title="تجربة هادئة ومريحة تبني الثقة"
              />
          ...
          <section id="location" className="relative z-10 section-padding">
            <div className="container">
              <div className="grid gap-10 lg:grid-cols-[.9fr_1.1fr]">
                <div>
                  <SectionHeading
                    badge="الموقع وصور المكان"
                    title="موقع واضح وصور تعكس راحة العيادة"
                  />
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {gallery.map((item, index) => (
                    <div key={item.title}>
                      <div className="overflow-hidden rounded-[2rem] border border-wine/10 bg-white shadow-sm">
          ...
          <section id="booking" className="relative z-10 section-padding bg-peach/60">
            <div className="container grid items-center gap-10 lg:grid-cols-[.9fr_1.1fr]">
              <div>
                <SectionHeading
                  badge="الحجز"
                  title="حجز إستشارة عن طريق واتساب"
                />
                <div className="grid gap-4 sm:grid-cols-2">
                  {[
            ...
            <div className="container">
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center lg:justify-between">
                <div className="space-y-5">
                  <a href="#home" aria-label="Leen home">
                    <Logo />
                  </a>
                    ...
                    {siteConfig.socials.map((social) => {
                      ...
                      return (
                        <a
                          ...
                          className="group inline-flex h-11 w-11 items-center justify-center rounded-full border border-wine/10 bg-white text-wine shadow-sm transition hover:-translate-y-1 hover:border-orange/40 hover:bg-orange hover:text-white hover:shadow-lg"
                        >
              ...
              <div className="mt-8 flex justify-center border-t border-wine/10 pt-5 text-sm text-muted-foreground">
                <span>
                  © {new Date().getFullYear()} {siteConfig.arabicName}. جميع الحقوق محفوظة.
                </span>
              </div>
            </div>
          </footer>
